...
st.caption(
    "The application transforms historical GitHub pull request data into "
    "governed, evidence-validated decision support."
)
...
with row_one[0]:
    st.markdown(
        ...
        <div class="arch-card">
            ...
            <p>
                Pull request metadata, descriptions, review activity,
                commits, changed files and historical outcomes are
...
with row_one[2]:
    st.markdown(
        ...
        <div class="arch-card">
            ...
            <p>
                Raw pull request data is cleaned and transformed into
                model ready features covering size, timing, activity,
...
with row_one[4]:
    st.markdown(
        """
        <div class="arch-card">
            <h3>3. Predictive models</h3>
            <p>
                Model 1 predicts whether a pull request is likely to merge.
                Model 2 predicts merge delay risk for eligible merged PRs.
            </p>
        </div>
        """,
        unsafe_allow_html=True,
...
with row_two[0]:
    st.markdown(
        """
        <div class="arch-card">
            <h3>4. Policy rules</h3>
            <p>
                Deterministic rules check documentation, testing, security,
                complexity, operational and governance concerns.
            </p>
        </div>
        """,
        unsafe_allow_html=True,
...
with row_two[2]:
    st.markdown(
        """
        <div class="arch-card">
            <h3>5. Unified intelligence</h3>
            <p>
                Model predictions and policy signals are combined into
                manual review requirements, policy risk and review priority.
            </p>
        </div>
        """,
        unsafe_allow_html=True,
...
with row_two[4]:
    st.markdown(
        """
        <div class="arch-card">
            <h3>6. RAG and Agentic RAG</h3>
            <p>
                Hybrid RAG retrieves relevant pull request evidence for the local LLM.
                A governed agentic workflow routes queries, validates citations and
                claims, attempts deterministic repair when required, and decides
                whether the answer should be released, withheld or refused.
            </p>
        </div>
        """,
        unsafe_allow_html=True,
...
st.markdown("### Governed Agentic RAG answer flow")

answer_flow = st.columns(
    [
        1,
        0.12,
        1,
...
for index, step in enumerate(
    ...
    with answer_flow[step_column]:
        st.markdown(
            f'<div class="flow-box">{step}</div>',
            unsafe_allow_html=True,
        )
...
st.markdown("## 4. Outcome and policy-risk overview")
...
st.markdown("## 5. How to use this application")

navigation_columns = st.columns(5)

navigation_columns[0].markdown(
    "**1. Data and PR Explorer**  \n"
    "Understand the dataset, filter records and inspect individual PRs."
)

navigation_columns[1].markdown(
    "**2. PR Intelligence**  \n"
    "Review predictions, policy rules and the recommended next action."
)

navigation_columns[2].markdown(
    "**3. Model and System Evaluation**  \n"
    "Assess predictive, retrieval and governed-AI quality."
)

navigation_columns[3].markdown(
    "**4. AI PR Analyst**  \n"
    "Ask natural language questions over governed pull request evidence."
)

navigation_columns[4].markdown(
    "**5. Project Documentation**  \n"
    "Review architecture, setup, responsible use and limitations."
)